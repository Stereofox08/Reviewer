...
const CategoriesAndEstablishments = () => {
    ...
    const handleCreateEstablishment = async () => {
        await axios.post('http://localhost:3001/establishments', newEstablishment);
    ...
    const handleDeleteEstablishment = async (establishmentId) => {
        await axios.delete(`http://localhost:3001/establishments/${establishmentId}`);
        fetchEstablishments();
    ...
    const handleEditCategory = async () => {
        await axios.put(`http://localhost:3001/categories/${editingCategory.id}`, { name: newCategoryName });
    ...
    const handleEditEstablishment = async () => {
        await axios.put(`http://localhost:3001/establishments/${editingEstablishment.id}`, newEstablishment);
